...
#Calculate RMSE when we have 7 variables and 500 trees:sqrt(5540391)
#RMSE=2353.804
...
yhat.bag = predict(model2 , newdata=data[-train ,])
...
yhat.bag = predict(model3 , newdata=data[-train ,])
